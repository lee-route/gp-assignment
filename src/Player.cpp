...
void Player::SolveArmFromAttachedTip(const Vec2& mouseWorld)
{
    Vec2 toMouse = mouseWorld - hammerAttachPoint;
    ...
    Vec2 elbow = hammerAttachPoint - forearmDir * forearmLength;
